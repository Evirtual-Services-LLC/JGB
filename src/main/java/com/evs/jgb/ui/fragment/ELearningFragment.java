...
public class ELearningFragment extends Fragment {
    ...
    private void intialize() {
        list = new ArrayList<>();
        list.add(new ArticleModel("1", "effective Learning"));
        list.add(new ArticleModel("2", "Maximize your day"));
    ...
    private void goTonextScreen() {
        ...
        bundle.putString(BUNDLE_KEY, "E-LEARNING");
    ...
    public void onResume() {
        super.onResume();
        text_toolbar.setText("E-LEARNING");
    }

...
public class LegalFormsFragment extends Fragment {
    ...
    private void intialize() {
        list = new ArrayList<>();
        list.add(new ArticleModel("1", "Children's Carpool Agreement"));
        list.add(new ArticleModel("2", "Request to Begin special Education"));
        list.add(new ArticleModel("3", "Temprary Guardianship Authorization"));
    ...
    private void goTonextScreen() {
        ...
        bundle.putString(BUNDLE_KEY, "LEGALFORMS");
    ...
    public void onResume() {
        super.onResume();
        text_toolbar.setText("LEGAL FORMS");
    }

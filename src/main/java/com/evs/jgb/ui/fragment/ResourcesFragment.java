...
public class ResourcesFragment extends Fragment {
    ...
    private void intialize() {
        list = new ArrayList<>();
        list.add(new ArticleModel("1", "American Pregenancy Association"));
        list.add(new ArticleModel("2", "Family History to ask Relative"));
        list.add(new ArticleModel("3", "Making a life "));
        list.add(new ArticleModel("4", "Maximimg your day"));
        list.add(new ArticleModel("5", "A Special online seminar"));
        list.add(new ArticleModel("6", "Emergency Prepaid"));
        list.add(new ArticleModel("7", "American Pregenancy Association"));
        list.add(new ArticleModel("8", "Family History to ask Relative"));
        list.add(new ArticleModel("9", "Making a life "));
        list.add(new ArticleModel("10", "Maximimg your day"));
        list.add(new ArticleModel("11", "A Special online seminar"));
        list.add(new ArticleModel("12", "Emergency Prepaid"));
    ...
    private void goTonextScreen() {
        ...
        bundle.putString(BUNDLE_KEY, "RESOURCES");
    ...
    public void onResume() {
        super.onResume();
        text_toolbar.setText("RESOURCES");
    }
